...
class GridView extends BaseListView
{
     ...
     *
     * - `{search}` : the search Form section. See [[renderSearch]].
    ...
    public function init()
    {
        ...
        if (!isset($this->headerRowOptions['id'])) {
            $this->headerRowOptions['id'] = $this->options['id'] . '-filters';
        }
    ...
    public function run()
    {
        ...
        $view->registerJs("jQuery('#$id').limeFamilyGridView($options);");
        parent::run();
    }
    ...
    public function renderSearch()
    {
        ...
        if (!isset($this->searchOptions['id'])) {
            $this->searchOptions['id'] = $this->getId();
        }
        $search =$this->search;
        ...
        $search_input_options['placeholder'] = $search_input_placeholder;

        $search_submit = Html::tag('span',
            Html::submitButton(Html::tag('i','',['class' => 'fa fa-search']) . $submit_btn_text,['class' => 'btn btn-default'])
            ,$search_submit_options);

        $search_input = Html::input('text',$search_input_name, $search_input_value, $search_input_options);
        ...
        $formEle = implode('',[
            Html::beginForm($action, $method, $this->searchOptions),
            $content,
            Html::endForm()
        ]);
