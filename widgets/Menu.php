...
//    }
    ...
    {
        if(isset($item['items'])) {
            $labelTemplate = '<a>{icon} {label}<span class="fa custom-arrow-icon"></span></a>';
            $linkTemplate = '<a>{icon} {label}<span class="fa custom-arrow-icon"></span></a>';
        }
        else {
        ...
        if (isset($item['url'])) {
            ...
            $replace = !empty($item['icon']) ? [
                '{url}' => Url::to($item['url']),
                '{label}' => $item['label'],
                '{icon}' => '<i class="navmenu-list-icon ' . $item['icon'] . '"></i>',
